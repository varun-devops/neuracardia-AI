...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget _buildStatCard(String title, String value, String unit, IconData icon, Color color, Color bgColor) {
    return Container(
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildDivider(),
                _buildInfoItem('Last Updated', _formatTime(_patientData.lastUpdated)),
                _buildDivider(),
  ...
  Widget _buildBiomarkerStats() {
    final troponin = _patientData.biomarkers.firstWhere((b) => b.name == 'Troponin');
    final ckMb = _patientData.biomarkers.firstWhere((b) => b.name == 'CK-MB');
    final myoglobin = _patientData.biomarkers.firstWhere((b) => b.name == 'Myoglobin');
  ...
  Widget _buildBiomarkerMiniCard(String name, String value, String unit, Color color, bool isElevated) {
    return Container(
